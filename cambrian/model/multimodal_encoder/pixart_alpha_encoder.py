...
from diffusers.models import Transformer2DModel, AutoencoderKL
...
class StableDiffusionVisionTower(BaseVisionTower):
    ...
    def load_model(self, device_map=None):
        self.vision_model = "stable-diffusion"
        ...
        self.vae: AutoencoderKL = onestep_pipe.vae
        self.transformer: Transformer2DModel = onestep_pipe.transformer
